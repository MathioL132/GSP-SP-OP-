...
// Part (ii): If one source is the parent of w, the other wins
// Part (ii): Trivial ears (source == w) win over non-trivial ears
if (ear_new.first == w && ear_current.first != w) return true;     // new is trivial, wins
